...
test('privateIp classifies correctly', () => {
  for (const ip of ['127.0.0.1', '10.1.2.3', '192.168.1.1', '172.16.0.1', '172.31.9.9',
    ...
    '100.64.0.1', '100.127.255.254', '192.0.0.8', '198.18.0.1', '198.19.255.1', '224.0.0.1', '239.1.1.1', '255.255.255.255', 'fe90::1', 'feb0::1', '::']) {
    assert.equal(privateIp(ip), true, ip + ' should be private');
  }
  for (const ip of ['1.1.1.1', '172.32.0.1', '8.8.8.8', '2606:4700::1111', '100.63.0.1', '100.128.0.1', '198.17.0.1', '198.20.0.1', '223.255.255.1', 'fec0::1']) {
